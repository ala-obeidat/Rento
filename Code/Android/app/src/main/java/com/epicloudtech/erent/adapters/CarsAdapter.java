...
public class CarsAdapter extends RecyclerView.Adapter<CarsAdapter.ViewHolder> {
    ...
    public CarsAdapter(Context context, ArrayList<SearchItemResponse> cars) {
        super();
    ...
    @Override
    public CarsAdapter.ViewHolder onCreateViewHolder(ViewGroup viewGroup, int i) {
    ...
    @Override
    public void onBindViewHolder(CarsAdapter.ViewHolder viewHolder, final int position) {
        ...
        viewHolder.tvPrice.setText(car.getDayCost() + " " + context.getString(R.string.SAR));
        ...
        if (Utils.getValue(context, Constants.IS_REGISTERED, false)) {
            viewHolder.providerTitle.setVisibility(View.VISIBLE);
            viewHolder.tvProvider.setVisibility(View.VISIBLE);
        }else {
            viewHolder.providerTitle.setVisibility(View.GONE);
            viewHolder.tvProvider.setVisibility(View.GONE);
        }
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        private final TextView carName, tvType, tvModel, tvYear, tvColor, tvProvider, tvBookNow, tvcall, tvFav, tvPrice,providerTitle;
        ...
        ViewHolder(View v) {
            ...
            providerTitle = v.findViewById(R.id.providerTitle);
