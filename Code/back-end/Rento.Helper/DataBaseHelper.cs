...
namespace Rento.Helper
{
    public class DataBaseHelper
    {
        ...
        public async Task ExecuteReader(string storedProcedure, Action<SqlDataReader> FetchReader)
        {
            try
            {
                using (var command = new SqlCommand(storedProcedure, new SqlConnection(CONNECTION_STRING)))
        ...
        public async Task ExecuteReader(string storedProcedure, Action<SqlCommand> FillCommand, Action<SqlDataReader> FetchReader)
        {
            try
            {
                using (var command = new SqlCommand(storedProcedure, new SqlConnection(CONNECTION_STRING)))
        ...
        public async Task ExecuteTransaction(Action<SqlCommand> ProcessCommand, Action<Exception> HandleException)
        {
            try
            {
