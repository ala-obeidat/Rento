...
namespace Rento.API.Controllers
{
    public class AccountController : BaseController
    {
        ...
        [HttpPost]
        public async Task<IHttpActionResult> Login(RentoRequest<UserLogin> request)
        {

            Logger.Debug("Login", request);
            request.Data.Username = request.Data.Username.Trim();
            return Ok(await TryCatchResponse(request, ValidateType.None, async  (RentoResponse<UserLoginResponse> response)=>
             {
        ...
        [HttpPost]
        public async Task<IHttpActionResult> ResendCode(RentoRequest request)
        {
            Logger.Debug("ResendCode", request);

            return Ok(await TryCatchResponseBase(request, ValidateType.Pending,
            async (RentoResponse response)=>
            {
